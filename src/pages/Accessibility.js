  ...
  return (
    ...
    <div id = "access-container">
      ...
      <div >
        ...
        <label for='courseName' class="form-label" id = "nam">Course Name:</label>
        ...
        <label for='teachersID' class="form-label"> Teachers ID</label>
        <input type="text" id='teachersID' name="teachersID" placeholder="Teachers ID" />
        
        <label for='teachersName' class="form-label">Your Name</label>
        ...
        <label for='classRoom' class="form-label">Classroom number</label>
